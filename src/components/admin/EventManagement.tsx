          ...
          <Dialog open={showBalanceReport} onOpenChange={setShowBalanceReport}>
            <DialogContent className="max-w-[95vw] sm:max-w-5xl max-h-[90vh] overflow-y-auto bg-white p-0 text-black">
              <div className="p-8 space-y-8 print:p-0">
                 <div className="border-b-2 border-emerald-900 pb-6 mb-8 flex justify-between items-center">
                  <div className="text-left">
                   ...
                   <div className="flex items-center gap-4">
                     ...
                     <div className="h-14 w-14 bg-emerald-deep/5 rounded-xl p-2 flex items-center justify-center">
                       <img 
                         src="https://ccrslflbnxdazvadjlvj.supabase.co/storage/v1/object/public/public_assets/logo-0.9588475542778425.png" 
                         alt="Logo" 
                         className="h-full object-contain"

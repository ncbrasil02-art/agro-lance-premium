...
export function SocialPreview({ title, description, image, siteUrl = "agropremium.com.br" }: SocialPreviewProps) {
  ...
  return (
    <div className="space-y-6 p-0 border rounded-2xl bg-white dark:bg-zinc-900 shadow-sm max-w-[500px] overflow-hidden pb-6">
      <div className="flex items-center gap-2 p-4 border-b bg-muted/5">
        ...
        <span className="text-xs font-bold uppercase tracking-wider text-muted-foreground">Prévia Redes Sociais (FB & X)</span>
      </div>

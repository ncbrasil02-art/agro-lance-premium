    ...
    <footer className="border-t border-border/60 bg-card/40">
      <div className="container mx-auto grid gap-8 px-4 py-12 md:grid-cols-4">
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm text-muted-foreground">
            <li>contato@premiumagro.com.br</li>
      ...
      <div className="border-t border-border/60">
        <div className="container mx-auto flex flex-col items-center justify-between gap-2 px-4 py-4 text-xs text-muted-foreground md:flex-row">
          <span>© 2025 Premium Agro Leilões. Todos os direitos reservados.</span>
          <span>CNPJ 00.000.000/0001-00 · Leiloeiro JUCESP nº 000</span>
        </div>
      </div>
    </footer>
  );

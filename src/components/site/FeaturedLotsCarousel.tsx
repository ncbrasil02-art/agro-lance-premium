        ...
        <div className={cn("relative z-10", isModern && "container mx-auto px-4")}>
          <div className="mb-12 flex flex-col md:flex-row md:items-end justify-between gap-6">
            <div>
              ...
              <h2 className={cn("text-4xl font-black uppercase italic tracking-tighter md:text-5xl", isModern ? "text-white" : "text-foreground")}>
                Lotes em <span className="text-gradient-gold">Destaque</span>
              </h2>
              <p className={cn("mt-3 max-w-xl text-lg font-medium", isModern ? "text-white/60" : "text-muted-foreground")}>
                Animais e embriões de linhagem superior com alto potencial genético para o seu plantel.
              </p>
            </div>
